...
class subcategoryjacket extends StatefulWidget {
  const subcategoryjacket({Key? key}) : super(key: key);

  @override
  State<subcategoryjacket> createState() => _subcategoryjacketState();
}
...
class _subcategoryjacketState extends State<subcategoryjacket> {
  final List<Sachen> infoBank = [
    Sachen(
      "Ruffty Body Warmer",
      "assets/jacketsub/Black-2-3.jpg",
    ),
  ];
  @override
