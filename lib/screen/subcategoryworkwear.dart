...
class subcategoryworkwear extends StatefulWidget {
  const subcategoryworkwear({Key? key}) : super(key: key);

  @override
  State<subcategoryworkwear> createState() => _subcategoryworkwearState();
}
...
class _subcategoryworkwearState extends State<subcategoryworkwear> {
  final List<Sachen> infoBank = [
    Sachen(
      "Ruffty Half Sleeve Lab Coat",
      "assets/workwearsub/WHITE-2-3.jpg",
    ),
    Sachen(
      "Ruffty Full Sleeve Lab Coat",
      "assets/workwearsub/BLUE-2.jpg",
    ),
  ];
  @override
